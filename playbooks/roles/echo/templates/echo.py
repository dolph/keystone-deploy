...
AUTH_TOKEN_CONF = {
    ...
    'auth_uri': 'http://{{ keystone_host | default(groups["keystone"][0]["ansible_default_ipv4"]["address"]) }}:35357/',
    'auth_url': 'http://{{ keystone_host | default(groups["keystone"][0]["ansible_default_ipv4"]["address"]) }}:35357/',
    'username': 'admin',
